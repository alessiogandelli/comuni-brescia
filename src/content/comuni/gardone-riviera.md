...
population: 2658
area: 21.28
coordinates: [45.6219, 10.5628]
centroid: [45.63688, 10.56667]
hasHistoric: true
hasNature: true
hasSport: true
hasFood: true
...
intro: ""
context: ""
fact: "Sede del Vittoriale degli Italiani, dimora di Gabriele D'Annunzio"
---
...
- Volo libero: **BigSur Sky Park**
- Volo libero
- Volo libero: **Decollo Monte Pirello**
- Punto panoramico
- Bocca della Fratta (659 m)
- Selva Alta (914 m)

## Luoghi importanti

- **Mausoleo degli Eroi** — Monumento

## Dove mangiare

- **Ristorante Pizzeria Nablus** (Ristorante)
- **Trattoria Riolet** (Ristorante)
- **Trattoria Pierolì** (Ristorante)
- **Trattoria Marietta** (Ristorante)
- **Lido 84** (Ristorante)
- **Bar D'Annunzio** (Caffè)

## Dove dormire

- **Residence Borgo degli Ulivi** (Hotel)
- **BigSur Sky Park** (B&B / Affittacamere)
- **Hotel Colomber** (Hotel)
- **Hotel Villa del Sogno** (Hotel)
- **Villa Florida** (Hotel)
