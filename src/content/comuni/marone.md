...
population: 3301
area: 23.58
coordinates: [45.7327, 10.0912]
centroid: [45.74641, 10.0981]
hasNature: true
hasSport: true
hasFood: true
...
- Arrampicata: **Falesia Marone**
- Arrampicata: **Falesia Madonna della Rota**
- Arrampicata: **Terra di Mezzo**
- Punto panoramico
- Anticima Punta Cunicolo (768 m)
- Punta Cunicolo (1034 m)
...
- **Bar Trattoria Belvedere** (Ristorante)
- **Alla Galleria** (Ristorante)
- **Bar L'espresso** (Caffè)
- **Novecento** (Caffè)
- **Cartapani** (Caffè)
- **Stop&Go** (Ristorante)
...
- **Camping Riva di San Pietro** (Campeggio)
- **La Tana di Sebastian** (B&B / Affittacamere)
- **Camping Vela** (Campeggio)
